...
import { Arme, Bouclier, Heros, Monstre, Nourriture, PointDeVies, Sacoche } from "./class_wow";

export  let equipeHeros: Heros[] = [
    // Heros 1
    new Heros("Arthas Menethil", new PointDeVies(30,30),  10 ,
    ...
    //  Heros 2 
    new Heros("Van Hellsing",new PointDeVies(25,25) ,250,
...
export let equipeMonstres: Monstre[] = [
    // Monstre 1
    new Monstre("Dracula", new PointDeVies(25,25),500,
    ...
    // Monstre 2 
    new Monstre("Grom", new PointDeVies(19,25),250,
