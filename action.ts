        ...
        function Jeu(equipeHeros: Personnage[], equipeMonstres: Personnage[]): Personnage {
          ...
          if (equipeAuHasard === 0) { 
            ...
            if(premierAttaquant.pointDeVie > 0){
                     ...
                     recupEndAuHasard === 0 ?  equipeMonstres[0].manger : console.log(`${equipeMonstres[0].nom} n'a pas eu le temps de regagner de l'endurance`);
            ...
            if(premierAttaquant.pointDeVie > 0){
                          ...
                          recupEndAuHasard === 0 ?  equipeHeros[0].manger : console.log(`${equipeHeros[0].nom} n'a pas eu le temps de regagner de l'endurance`);
